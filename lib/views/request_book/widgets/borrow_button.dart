...
class BorrowButton extends StatefulWidget {
  ...
  final BookRequestHandlingService bookRequestServices;
    ...
    return Consumer<BookRequestHandlingService>(
      builder: (context, consumer, child) {
        return StreamBuilder<bool>(
            stream: consumer.checkIfBookIsAvailableForBorrowAsStream(
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (snapshot.hasData && snapshot.data == true) {
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        return Center(
                          child: SizedBox(
                            ...
                            child: FilledButton(
                              onPressed:
                                  !requestExists ? widget.onPressed : null,
                              child: Row(
                  ...
                  return const Center(
                    child: FilledButton(
                        onPressed: null,
                        child: Text('Book is not available currently')),
                  );
                }
              } else {
                return Text('Error: ${snapshot.error}');
