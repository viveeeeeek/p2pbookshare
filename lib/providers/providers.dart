...
import 'package:p2pbookshare/view_models/search_viewmodel.dart';
import 'package:p2pbookshare/views/upload_book/upload_book_viewmodel.dart';
...
import 'package:p2pbookshare/providers/others/connectivity_service.dart';
import 'package:p2pbookshare/providers/others/gemini_service.dart';
...
import 'package:p2pbookshare/providers/shared_prefs/user_data_prefs.dart';
...
final List<ChangeNotifierProvider> appProviders = [
  ...
  ChangeNotifierProvider<BookRequestHandlingService>(
      create: (_) => BookRequestHandlingService()),
